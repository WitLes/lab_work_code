...
def topology_generating(initial_graph):   # 生成拓扑结构
	try:
		...
		G.add_weighted_edges_from([[9,16,0],[9,17,0],[9,18,0],[9,19,0]])
...
# 确定每个节点在图像中的位置
pos1 = {0:[1,3.5],1:[2,2],2:[2,3],3:[2,4],4:[2,5],5:[3,2],6:[3,2.7],7:[3,3.6],8:[3,4.4],9:[4,1],10:[4,2],11:[4,3],12:[4,4],13:[4,5],14:[4,6],15:[4,7],16:[5,1],17:[5,2],18:[5,3],19:[5,4],20:[5,5]}
...
nx.draw(G,pos=pos1,with_labels=True,node_color='red')#按参数构图  
plt.axis('off')
plt.show()#显示图像
...
nx.draw(Diffusion_Tree,pos=pos1,with_labels=True,node_color='blue')#按参数构图  
plt.axis('off')
plt.show()#显示图像
