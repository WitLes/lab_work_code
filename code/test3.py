...
if __name__ == "__main__":
    ...
    dats, dat_path = dats_generator(demo_graph, dat_number=node_number, seed=True)
    discrete_wtd, discrete_mass = continuous_func_distribution2discrete()
    adj_mat = faster_topology_reconstruction_through_dats_based_on_wtd(dats, discrete_wtd)
